      ...
      <ProjectContent>
        ...
        <div className="desc">
          ...
          <p>A The Office theme tic tac toe game. This game is built with React, HTML5, CSS3, SASS, Styled Components, and Javascript.
           <br />
            <p className="subdesc">&#47;&#47; Responsive</p>
          </p>
...
export const DMVTest = () => {
  return (
    <ProjectWrapper>
      <ProjectContent>
        <ProjcetImageStyle src={ttt} alt="dmv permit practice test" />
        <div className="desc">
          <h2>DMV Permit Practice Test</h2>
          <p>This test is built with React, HTML5, CSS3, SASS, Styled Components, and Javascript.
          <br />
            <p className="subdesc">&#47;&#47; Responsive</p>
          </p>
          <ul className="buttons">
